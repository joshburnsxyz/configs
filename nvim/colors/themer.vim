  ...
  let s:guishade0 = "#303030"
  let s:guishade1 = "#4e4d4d"
  let s:guishade2 = "#6b6a6a"
  let s:guishade3 = "#898787"
  let s:guishade4 = "#a6a3a3"
  let s:guishade5 = "#c4c0c0"
  let s:guishade6 = "#e1dddd"
  let s:guishade7 = "#fffafa"
  let s:guiaccent0 = "#ff6b6b"
  let s:guiaccent1 = "#fffafa"
  let s:guiaccent2 = "#ffee33"
  let s:guiaccent3 = "#73ff57"
  let s:guiaccent4 = "#4dfcff"
  let s:guiaccent5 = "#7094ff"
  let s:guiaccent6 = "#fffafa"
  let s:guiaccent7 = "#fd6bff"
